            ...
            <div class="grid lg:grid-cols-3 gap-8 mt-12">
                ...
                <div class="lg:border-l lg:pl-8">
                    ...
                    <ul class="text-[#333] mt-6 space-y-4">
                        ...
                        <li class="flex flex-wrap gap-4 text-sm">Discount (20%) <span class="ml-auto font-bold line-through">$4.00</span></li>
                        <li class="flex flex-wrap gap-4 text-sm">Tax <span class="ml-auto font-bold line-through">$4.00</span></li>
                        <li class="flex flex-wrap gap-4 text-base font-bold border-t pt-4">Total <span class="ml-auto">$Total</span></li>
                    </ul>
                </div>
            </div>
            <div class="flex flex-wrap gap-4 mt-10">
                <button type="button" wire:click="Home"
                        class="px-6 py-3.5 text-sm bg-transparent border text-[#333] rounded-md hover:bg-gray-100">Pay later</button>
                <button type="button" wire:click="checkedOut"
